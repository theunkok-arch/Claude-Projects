const mockNeighbourhoods = {
  ...
  'Bilthoven': {
    ...
    demographics: { avgAge: 44, families: '48%', singles: '15%', couples: '37%' },
    transport: ['Bus 77 to Utrecht Centraal', 'Train Bilthoven station (Intercity)', 'A28 motorway (5 min)'],
    nearby: ['De Biltsche Hoek', 'Bos Bilthoven', 'International School Utrecht', 'Shopping centre De Kwinkelier'],
    overbidHistory: [
      { quarter: 'Q1 2024', percentage: 1.2, count: 8 },
      { quarter: 'Q4 2023', percentage: 1.5, count: 6 },
      { quarter: 'Q3 2023', percentage: 2.0, count: 9 },
      { quarter: 'Q2 2023', percentage: 2.4, count: 11 },
    ],
  },
  'Kralingen': {
    name: 'Kralingen',
